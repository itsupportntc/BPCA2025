...
{
    public partial class BuildingSummaryxl : GrapeCity.ActiveReports.SectionReport
    {
        private DataSet _ds;
        public BuildingSummaryxl(DataSet ds)
        {
            InitializeComponent();
            _ds = ds;
        ...
        {
            BuildingSummaryReport_Summaryxl rpt = new BuildingSummaryReport_Summaryxl(_ds.Tables[0], _ds.Tables[2]);
            rpt.Run();
