...
namespace CondoDeficiencyReports
{
    ...
    /// </summary>
    public partial class BuildingSummaryReport_Summary : GrapeCity.ActiveReports.SectionReport
    {
        DataTable _hdrData;
        DataTable _dtlData;
        public BuildingSummaryReport_Summary(DataTable hdrData, DataTable dtlData)
        {
            InitializeComponent();
            _hdrData = hdrData;
            DataSource = dtlData;
