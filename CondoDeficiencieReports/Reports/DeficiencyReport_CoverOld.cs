...
namespace CondoDeficiencyReports
{
    ...
    /// </summary>
    public partial class DeficiencyReport_CoverOld : GrapeCity.ActiveReports.SectionReport
    {
        private DataTable _headerDt;
        private DataTable _detailDt;
        private DataTable _detailTempDt;

        public DeficiencyReport_CoverOld(DataTable headerDt, DataTable detailDt, DataTable detailTempDt)
        {
            InitializeComponent();
            _headerDt = headerDt;
            _detailDt = detailDt;
