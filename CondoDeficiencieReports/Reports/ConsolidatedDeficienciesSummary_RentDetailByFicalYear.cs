...
namespace CondoDeficiencyReports
{
    ...
    /// </summary>
    public partial class ConsolidatedDeficienciesSummary_RentDetailByFicalYear : GrapeCity.ActiveReports.SectionReport
    {
        private DataTable _dt;
        private DateTime _asOf;
        private DateTime _startdate;
        public ConsolidatedDeficienciesSummary_RentDetailByFicalYear(DataTable dt, DateTime asOf)
        {
            InitializeComponent();
            _dt = dt;
            _asOf = asOf;
