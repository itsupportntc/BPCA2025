...
namespace CondoDeficiencyReports
{
    ...
    /// </summary>
    public partial class ConsolidatedDeficiencies_AgingByYear : GrapeCity.ActiveReports.SectionReport
    {
        private DataTable _dt;
        private DateTime _asOf;
        public ConsolidatedDeficiencies_AgingByYear(DataTable dt, DateTime asOf)
        {
            InitializeComponent();
            _dt = dt;
            _asOf = asOf;
