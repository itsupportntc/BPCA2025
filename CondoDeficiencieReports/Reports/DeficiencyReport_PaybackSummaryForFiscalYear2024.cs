...
namespace CondoDeficiencyReports
{
    ...
    /// </summary>
    public partial class DeficiencyReport_PaybackSummaryForFiscalYear2024 : GrapeCity.ActiveReports.SectionReport
    {
        private DateTime _asOf;
        public DeficiencyReport_PaybackSummaryForFiscalYear2024(DataTable dt, DateTime asOf)
        {
            InitializeComponent();
